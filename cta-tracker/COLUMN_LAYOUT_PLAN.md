...
| One direction only (terminals, Loop stations, late-night gaps) | Render that group full width in the same style; never an empty placeholder column | Every Loop stop for Brown/Orange/Pink/Purple and every terminal would otherwise carry a permanent empty half-screen. |
